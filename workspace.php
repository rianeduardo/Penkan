...
<head>
    ...
    <title>PENKAN | Workspace - <?php echo htmlspecialchars($workspace['title']); ?></title>
    ...
    <main class="container">
                    ...
                    <?php foreach ($todo_cards as $card): ?>
                        <div class="card">
                            ...
                            <div style="margin-top:8px;display:flex;gap:6px;">
                                <form action="move_card.php" method="post" style="display:inline;"><input type="hidden"
                                        name="card_id" value="<?php echo $card['id']; ?>"><input type="hidden" name="to"
                                        value="doing"><button type="submit">Mover → Fazendo</button></form>
                                <form action="move_card.php" method="post" style="display:inline;"><input type="hidden"
                                        name="card_id" value="<?php echo $card['id']; ?>"><input type="hidden" name="to"
                                        value="done"><button type="submit">Mover → Feito</button></form>
                                <form action="delete_card.php" method="post" style="display:inline;margin-left:auto;"
                                    onsubmit="return confirm('Deletar este card?');"><input type="hidden" name="card_id"
                                        value="<?php echo $card['id']; ?>"><button type="submit">Excluir</button></form>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
                    ...
                    <?php foreach ($doing_cards as $card): ?>
                        <div class="card">
                            ...
                            <div style="margin-top:8px;display:flex;gap:6px;">
                                <form action="move_card.php" method="post" style="display:inline;"><input type="hidden"
                                        name="card_id" value="<?php echo $card['id']; ?>"><input type="hidden" name="to"
                                        value="todo"><button type="submit">← Voltar</button></form>
                                <form action="move_card.php" method="post" style="display:inline;margin-left:auto;"><input
                                        type="hidden" name="card_id" value="<?php echo $card['id']; ?>"><input type="hidden"
                                        name="to" value="done"><button type="submit">Mover → Feito</button></form>
                    ...
                    <?php foreach ($done_cards as $card): ?>
                        <div class="card">
                            ...
                            <div style="margin-top:8px;display:flex;gap:6px;">
                                <form action="move_card.php" method="post" style="display:inline;"><input type="hidden"
                                        name="card_id" value="<?php echo $card['id']; ?>"><input type="hidden" name="to"
                                        value="doing"><button type="submit">← Voltar</button></form>
                                <form action="delete_card.php" method="post" style="display:inline;margin-left:auto;"
                                    onsubmit="return confirm('Deletar este card?');"><input type="hidden" name="card_id"
                                        value="<?php echo $card['id']; ?>"><button type="submit">Excluir</button></form>
                            </div>
        ...
        <section style="max-width:900px;margin:18px auto;padding:12px;background:#0b0b0b;border-radius:8px;">
            ...
            <form action="update_workspace_notes.php" method="post">
                ...
                <textarea name="notes"
                    style="width:100%;min-height:140px;padding:8px;border-radius:6px;margin-bottom:8px;"><?php echo htmlspecialchars($workspace['notes'] ?? ''); ?></textarea>
        ...
        <div id="createCardModal"
            style="display:none; position:fixed; left:0; top:0; right:0; bottom:0; background:rgba(0,0,0,0.5); z-index:9999;">
            <div style="background:#fff; color:#111; max-width:600px; margin:6% auto; padding:20px; border-radius:8px;">
                ...
                <form action="create_card.php" method="post">
                    ...
                    <div><input type="text" name="title" placeholder="Título" required
                            style="width:100%;padding:8px;margin-bottom:8px;"></div>
                    <div><textarea name="description" placeholder="Descrição"
                            style="width:100%;padding:8px;margin-bottom:8px;"></textarea></div>
                    <div>
                        <label>Preset:</label>

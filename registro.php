        ...
        <div class="containerCadastro">
            <div class="caixaCadastro">
                ...
                <form action="registro.php" method="post" class="formCadastro">
                    ...
                    <input id="email" type="email" name="email" placeholder="usuario@penkan.com" required
                        class="entrada">
                    <div class="labelRow">
                    ...
                    <button type="submit" class="btnPrimario botaoSalvar">
                        <div class="labelRow"><svg xmlns="http://www.w3.org/2000/svg" height="20px"
